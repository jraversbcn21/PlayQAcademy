...
- **Exams:** 4 defined (`exam-module-1`, `exam-module-2-3`, `exam-midterm`, `exam-final`); only `exam-module-1` has a bank (25 q). The other 3 are gated "Coming Soon" via `isExamReady` until m2-m8 banks exist.
